...
export interface ApiCasestudydetaildataCasestudydetaildata
  extends Schema.CollectionType {
  collectionName: 'casestudydetailsdata';
  info: {
    singularName: 'casestudydetaildata';
    pluralName: 'casestudydetailsdata';
    displayName: 'casestudydetaildata';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    caseStudyDetail: Attribute.JSON;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::casestudydetaildata.casestudydetaildata',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiDetailedblogDetailedblog extends Schema.CollectionType {
  ...
  info: {
    singularName: 'detailedblog';
    pluralName: 'detailedblogs';
    displayName: 'BlogDetailsData';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    detailedblog: Attribute.JSON;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::detailedblog.detailedblog',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
